...
# this repo, extended with PATH-stubbed brew/curl/id binaries that log
...
# --- Stub bin dir: brew/curl/id log their invocation instead of running for
# real. Not exercised by this ticket's steps, but stood up here so later
# tickets (oh-my-zsh install, Homebrew/Brewfile install) can reuse this
...
pass "re-running bootstrap.sh on an already-bootstrapped HOME produces no duplicate config entries"

# ==================================================================
# Scenario B: config/files already correct up front — left untouched.
# ==================================================================
...
pass "brew/curl/id stubs were not invoked by bootstrap.sh's git-config/permission steps"

# ======================================================================
# Scenario C: ~/.zshrc.local present with loose permissions gets tightened.
# ======================================================================
...
# ==========================================================
# Scenario D: missing bare-repo checkout fails loudly, not silently.
# ==========================================================
